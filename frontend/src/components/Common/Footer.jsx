...
const Footer = () => {
  return (
    <footer className="border-t py-12 px-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-4 lg:px-0">
        <div>
          ...
          <form className="flex">
            ...
            <button
              type="submit"
              className="bg-squad-navy-blue text-white px-4 py-3 text-sm rounded-r-md hover:bg-squad-dark-light-blue transition-all cursor-pointer"
            >
              Subscribe
            </button>
          </form>
      ...
      {/* Bottom Footer */}
      <div className=" container mx-auto border-t mt-12 px-4 lg:px-0 border-gray-300 pt-6">
